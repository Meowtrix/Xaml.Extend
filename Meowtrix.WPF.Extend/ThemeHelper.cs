...
namespace Meowtrix.WPF.Extend
{
    ...
    {
        // origin:https://github.com/danielmoore/SystemThemeChange/blob/master/ThemeHelper.cs
        ...
        private static readonly MethodInfo FilteredSystemThemeFilterMessageMethod = typeof(SystemThemeHelper).GetMethod("FilteredSystemThemeFilterMessage", StaticNonPublic);
        private static readonly MethodInfo SystemThemeFilterMessageMethod = typeof(SystemThemeHelper).GetMethod("EmptySystemThemeFilterMessage", StaticNonPublic);
        ...
        private static IntPtr EmptySystemThemeFilterMessage(IntPtr hwnd, int msg, IntPtr wParam, IntPtr lParam, ref bool handled) => IntPtr.Zero;
